...
<body>
    ...
    <div id="exeDetail" title="Job執行明細">
		...
		<table title="Step Execution Status" style="${table1}">
			<tr>
				<th style="${th1}">StepName</th>
				<th style="${th1}">Reads</th>
				<th style="${th1}">Writes</th>
				<th style="${th1}">Commits</th>
				<th style="${th1}">Rollbacks</th>
				<th style="${th1}">Duration</th>
				<th style="${th1}">Status</th>
				<th style="${th1}">ExitMessage</th>
			</tr>
