...
public class RuleTbMntHandler extends MFormHandler {
    ...
    public IResult saveRuleTbDtl(IRequest request) {
        ...
        if (ftGridData != null) {
            ...
            for (int i = 0; i < ftGridData.length; i++) {
                ...
                // if(!CapString.isEmpty(jsData.getString("oid")) &&
                // !rlItm.getDivRlDtls().isEmpty()){
    ...
    public IResult dwnload(IRequest request) throws CapException {
        ...
        try {
            ...
            // return new FileDownloadResult(request, file.getPath(),
            // file.getName(), "xls/plain");
    ...
    public File createDecisionTable(IRequest request) {
        ...
        // String importClass =
        // "com.iisigroup.cap.base.model.CaseInfo,com.iisigroup.cap.utils.CapDroolsUtil";r
        // String variablesName =
        // "com.iisigroup.cap.utils.CapDroolsUtil comUtil";
        ...
        try {
            ...
            // 設欄位框(細)線
            // headCellFmt.setBorder(Border.ALL,BorderLineStyle.THIN,
            // Colour.BLACK);
            // 設定顏色
    ...
    public IResult testDrools(IRequest request) {
        ...
        try {
            ...
            // kbuilder.add(ResourceFactory.newClassPathResource("rule_export.xls",
            // getClass()), ResourceType.DTABLE, dtconf);
