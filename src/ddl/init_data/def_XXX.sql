...
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('13','unitMins','60','分鐘',1,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('14','unitMins','3600','小時',1,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('15','unitMins','86400','天',1,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('16','unitMins','604800','週',1,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('17','scopeTyp','0','個人',1,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('18','scopeTyp','1','組別(業務)',2,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('19','scopeTyp','2','群組',3,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('20','scopeTyp','3','部門',4,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('21','scopeTyp','9','全體',5,'zh_TW','system',current timestamp);

insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('22','hours','00','00',1,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('23','hours','01','01',2,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('24','hours','02','02',3,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('25','hours','03','03',4,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('26','hours','04','04',5,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('27','hours','05','05',6,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('28','hours','06','06',7,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('29','hours','07','07',8,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('30','hours','08','08',9,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('31','hours','09','09',10,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('32','hours','10','10',11,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('33','hours','11','11',12,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('34','hours','12','12',13,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('35','hours','13','13',14,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('36','hours','14','14',15,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('37','hours','15','15',16,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('38','hours','16','16',17,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('39','hours','17','17',18,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('40','hours','18','18',19,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('41','hours','19','19',20,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('42','hours','20','20',21,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('43','hours','21','21',22,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('44','hours','22','22',23,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('45','hours','23','23',24,'zh_TW','system',current timestamp);

insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('46','minutes','00','00',1,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('47','minutes','10','10',2,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('48','minutes','20','20',3,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('49','minutes','30','30',4,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('50','minutes','40','40',5,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('51','minutes','50','50',6,'zh_TW','system',current timestamp);

insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('52','styleTyp','0','文字',1,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('53','styleTyp','1','彈出對話框',2,'zh_TW','system',current timestamp);
insert into cfg_CodeType(oid,codeType,codeValue,CodeDesc,codeOrder,locale,updater,updateTime) values('54','styleTyp','2','電子郵件',3,'zh_TW','system',current timestamp);