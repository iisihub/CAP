	...
	$(document).ready(function(){
		...
		var grid = $("#gridview").jqGrid({
            ...
            colModel: [{
                ...
                name: 'level', align: "center", width: 60, sortable: true
            },  {
                header: i18n['funcSet']['funcsequence'],//"排列順序",
                name: 'sequence', align: "center", width: 60, sortable: true
            },  {
                header: i18n['funcSet']['funcsysType'],//"系統別",
                name: 'SYSNAME', index: 'sysType', align: "center", width: 150, sortable: true
            },  {
                name: 'sysType', hidden: true
            }],
