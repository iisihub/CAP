	...
	$(document).ready(function(){
		...
		var grid = $("#gridview").jqGrid({
            ...
            colModel: [{
                ...
                name: 'code', align: "left", width: 10, sortable: true,
                ...
                name: 'proxy', align: "left", width: 15
            },  {
                header: i18n['department']['depmanager'],//"單位經理",
                name: 'manager', align: 'left', width: 15, sortable: false
            },  {
                header: i18n['department']['depaddr'],//"地址",
                name: 'addr', align: 'left', width: 35, sortable: false
