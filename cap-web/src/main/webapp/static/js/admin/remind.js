pageInit(function(){
	$(document).ready(function(){
		...
		var grid = $("#gridview").jqGrid({
			url: 'webroot/remindhandler/query',
            ...
            colModel: [{
                ...
                name: 'startDate', align: "left", width: 10, sortable: false
            },  {
                header: i18n['remind']['content'],//"提醒事項
                name: 'content', align: "left", width: 45, sortable: true
            },  {
		...
		$(".btns").find("#add").click(function(){//新增
	        ...
	        if (id) {
	            ...
	            API.showConfirmMessage(i18n.def['del.confrim'], function(b){
	                if (b) {
	                    $.ajax({
	                    	url: 'webroot/remindhandler/delete',
	                        data: {
	                            oid: rowObject.oid
	                        },
