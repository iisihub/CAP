(function($){
    ...
    function init(){
        ...
        (msgContainer = msgContainer || $("<div id='msgContainer'><div class='innerTitle ui-state-default' >" + mi18n.messageArea + "</div><div id='innerShowall'><p>" + ""/*mi18n.showAll*/ + "</p></div><div id='inner'></div></div>").prepend($("<div class='innerTitle' style='float:right'>ｘ　</div>").click(buttonClick))).appendTo(newMsg.find("#newSysMsgArea_inner"));
