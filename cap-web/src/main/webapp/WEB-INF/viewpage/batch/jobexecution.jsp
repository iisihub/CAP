		...
		<div id="exeDetailDialog" class="hide"
			...
			<form id="jdform" onsubmit="return false;">
				<table class="row-data">
					...
					<tr>
						<th><spring:message code="js.startTime"><!--開始時間--></spring:message></th>
						<td><span id="START_TIME"></span></td>
						<th><spring:message code="js.duration"><!--花費時間--></spring:message></th>
					...
					<tr>
						<th><spring:message code="label.jobParameter"><!--排程參數--></spring:message></th>
						<td colspan="3"><textarea id="jobParams" name="jobParams" cols="70" rows="2" readonly="readonly"></textarea></td>
					</tr>
					<tr class="hide">
						<th><spring:message code="label.otherMessage"><!--其它資訊--></spring:message></th>
