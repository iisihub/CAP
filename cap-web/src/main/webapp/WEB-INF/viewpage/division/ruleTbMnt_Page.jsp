					...
					<tbody>
						...
						<tr>
							...
							<td width="53%" colspan="3">
								<input name="RadioGroup1" value="A" id="RadioGroup1" type="radio" />金額平均
								<input name="RadioGroup1" value="B" id="RadioGroup1" type="radio" />件數平均
								<input name="RadioGroup1" value="C" id="RadioGroup1" type="radio" />人數平均
								<input name="RadioGroup1" value="D" id="RadioGroup1" type="radio" />新增金額平均
								<input name="RadioGroup1" value="E" id="RadioGroup1" type="radio" />新增件數平均
							</td>
						</tr>
					</tbody>
				</table>
