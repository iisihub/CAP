...
<title><spring:message code="group.title">
		<!--語系-->
	</spring:message></title>
</head>
<body>
	<script>
		loadScript('js/division/groupStng');
	</script>
	<div>
		<form id="mform" onsubmit="return false;">
			<!--<fieldset class="row">
                -->
			<input type="text" id="oid" name="oid" class="hide" /><input
				type="text" id="mtype" name="mtype" class="hide" />
			<table class="row-data">
				...
				<tr>
					...
					<td><input type="text" id="codeValue" maxlength="48"
						name="codeValue" class="validate[required,funcCall[maxUTF8[48]]]" />
					</td>
				</tr>
				<tr>
					...
					<td><input type="text" id="codeDesc" name="codeDesc"
						maxlength="100" class="validate[funcCall[maxUTF8[100]]]" /></td>
