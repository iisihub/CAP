...
<title><spring:message code="errorCode.title"><!--訊息代碼維護--></spring:message></title>
</head>
<body>
	<script>
                ...
                <table class="tb2" width="99%" border="0" cellspacing="0" cellpadding="0" id="searchTable">
                    <tbody>
                        <tr>
                            ...
                            <td width="60%">
                                <input type="text" size="20" id="code" name="code" maxlength="20"/>
                            </td>
                        </tr>
                        <tr>
                ...
                <table class="tb2" width="99%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            ...
                            <td width="30%">
                                <select id="locale" name="locale" combokey="lang" space="true" class="validate[required]"></select>
                            </td>
                        </tr>
                        <tr>
                            <td width="20%" class="hd1">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <textarea type="text" rows="5" cols="50" id="message" name="message" maxlength="512" class="validate[required]"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td width="20%" class="hd1"><spring:message code="js.suggestion"></spring:message></td>
                            <td colspan="3">
                                <textarea id="suggestion" name="suggestion" rows="5" cols="50"></textarea>
                            </td>
                        </tr>
                        <!-- 
                        <tr>
