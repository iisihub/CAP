                ...
                <table class="tb2" width="99%" border="0" cellspacing="0" cellpadding="0" id="searchTable">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="level" name="level" combokey="funcLevel" combotype="2"></select>
                            </td>
                        </tr>
                        <tr>
                            <td class="hd1"><spring:message code="js.funccode"></spring:message></td>
                            <td>
                                <input type="text" size="6" id="code" name="code" maxlength="6">
                            </td>
                        </tr>
                        <tr>
                            <td class="hd1"><spring:message code="js.funcname"></spring:message></td>
                            <td>
                                <input type="text" size="15" id="name" name="name" maxlength="162">
                            </td>
                        </tr>
                    </tbody>
                </table>
