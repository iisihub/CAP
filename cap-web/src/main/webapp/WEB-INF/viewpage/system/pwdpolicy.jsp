    ...
    <form id="mform" onsubmit="return false;">
      ...
      <table class="row-data">
        <tr>
          ...
          <td><input type="text" id="expired_day" name="expired_day"
            maxlength="32" size="10" class="numeric" /> <spring:message
              code="pwdpolicy.days" /></td>
        </tr>
        <tr>
          <th><spring:message code="pwdpolicy.min_length" /></th>
          <td><input type="text" id="min_length" name="min_length" maxlength="32"
            size="10" class="numeric" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="text" id="max_history" name="max_history"
            maxlength="100" size="10" class="numeric" /> <spring:message
              code="pwdpolicy.generation" /></td>
        </tr>
        <tr>
          <th><spring:message code="pwdpolicy.captcha_enable" /></th>
          <td><spring:message code="pwdpolicy.errors" /><input type="text"
            id="captcha_enable" name="captcha_enable" size="10" maxlength="100"
            class="numeric" /> <spring:message code="pwdpolicy.times" /></td>
        </tr>
        <tr>
          <th><spring:message code="pwdpolicy.account_lock" /></th>
          <td><spring:message code="pwdpolicy.errors" /><input type="text"
            id="account_lock" name="account_lock" size="10" maxlength="100"
            class="numeric" /> <spring:message code="pwdpolicy.times" /></td>
        </tr>
        <tr>
