...
public class SendingMultipleMessagesRequest implements EventRequest {
    ...
    public SendingMultipleMessagesRequest(Collection<String> to, Long toChannel, String eventType, SendingMultipleMessagesRequestContent content) {
        this.to = to;
    ...
    public SendingMultipleMessagesRequestContent getContent() {
        return content;
    }
}
